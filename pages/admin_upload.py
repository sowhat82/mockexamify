...
Allows admins to upload mock exams via CSV/JSON files
"""
...
def show_admin_upload():
    ...
    st.markdown("Upload a new mock exam from CSV or JSON file")
    ...
    with st.form("upload_mock_form"):
        ...
        with col2:
            ...
            time_limit = st.number_input(
                ...
                max_value=180,
                value=60,
                help="Maximum time allowed for the exam"
            )
...
async def process_mock_upload(title: str, description: str, category: str, 
                            ...
                            time_limit: int, uploaded_file) -> bool:
