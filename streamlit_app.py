...
st.set_page_config(
    page_title="WantAMock - CACS & CMFAS Mock Exam Practice Papers | AI-Powered",
    page_icon="🎯",
    layout="wide",
...
def main():
    ...
    # Note: Explanation health check moved to upload time for better performance
    # See admin_upload.py for post-upload health check
...
def show_authentication_page(auth: AuthUtils):
    ...
    <div class="welcome-section">
        ...
        <p>CACS & CMFAS Mock Exam Practice Papers</p>
    </div>
    """,
        unsafe_allow_html=True,
    )

    # SEO-friendly description (visible text that Google indexes)
    st.text("Practice for CACS, CMFAS and other MAS financial exams with AI-powered mock papers. Realistic questions, instant grading and detailed explanations to help you pass.")
    ...
    with col1:
        ...
        <div class="feature-card">
            <h4>📚 CACS & CMFAS Mock Papers</h4>
            <p>• CACS Module 5, 6A, 6 practice questions</p>
            <p>• CMFAS M1A, M5, M8, M8A, M9A mock exams</p>
            <p>• Realistic exam scenarios with AI grading</p>
        </div>
        """,
            unsafe_allow_html=True,
        )
    ...
    with st.expander("❓ FAQ"):
        st.markdown(
            """
**What exams can I practice for?**
We offer mock papers for CACS (Capital Markets and Financial Advisory Services) modules and CMFAS exams regulated by MAS Singapore, including M1A, M5, M8, M8A, M9A, Module 5, Module 6A, and more.
...
New users receive 1 free credit to try a full mock paper. No credit card required.
"""
        )
