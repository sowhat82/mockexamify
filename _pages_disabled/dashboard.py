...
def show_available_question_pools(user: Dict[str, Any]):
    ...
    st.markdown("### 🎯 Take an Exam from Question Pools")
    st.success("✅ **Version 2.0** - Dynamic Pools Loaded Successfully!")
    st.info("💡 Questions are randomly selected from pools each time - get a fresh exam every attempt!")
...
def show_no_pools_message():
    ...
    <div style="text-align: center; padding: 3rem 1rem;">
        ...
        <h3>No Question Pools Available</h3>
