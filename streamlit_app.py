...
def show_password_reset_ticket_form():
    ...
    st.markdown('<h3 style="color: #000000;">🔑 Request Password Reset</h3>', unsafe_allow_html=True)
    st.markdown(
            ...
            if not email:
                ...
                if not email_valid:
                    ...
                    if ticket_id:
                        ...
                        st.error("❌ Failed to submit request. Please try again or contact support directly.")
