...
try:
    from components.dashboard import handle_dashboard_modals, show_dashboard
except ImportError:
...
try:
    from components.purchase_credits import (
...
try:
    from components.past_attempts import handle_modals, show_past_attempts
except ImportError:
...
st.set_page_config(
    page_title="MockExamify", page_icon="🎯", layout="wide", initial_sidebar_state="collapsed"
)
